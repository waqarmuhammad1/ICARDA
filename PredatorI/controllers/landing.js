$(document).ready(function () {
    ...
    $("#sign_in").click(function(){
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/auth", 'application/json', request, function (response) {
    ...
    $("#register_reg").click(function(){
        ...
        console.log(request)
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/register", 'application/json', request, function (response) {
