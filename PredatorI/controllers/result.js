$(document).ready(function () {
    ...
    window.onload = function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_analysis_mode", 'application/json', null, function (branches) {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_algorithm_results", 'application/json', null, function (branches) {
