$(document).ready(function () {
    ...
    $("#view_change").click(function () {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_processed_data",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    $("#confirm_yes").click(function () {
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/overwrite_existing_data", 'application/json', null, function (response) {
    ...
    function get_selected_data() {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_selected_data",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function get_data_description() {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_data_description",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function get_train_vars() {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_train_vars",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function get_target_vars() {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_target_vars",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function get_data_correlation() {
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_data_correlation",
            data: null,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function get_selected_columns() {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_selected_columns", 'application/json', null, function (branches) {
    ...
    function get_string_columns() {
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_string_columns", 'application/json', null, function (branches) {
    ...
    function get_file_name() {
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_download_file_name", 'application/json', null, function (response) {
    ...
    function get_applied_methods() {
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_applied_methods", 'application/json', null, function (branches) {
            console.log(data)
            try {
    ...
    function get_attributes_encoded() {
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_attributes_encoded", 'application/json', null, function (branches) {
    ...
    $("#filter_options").on('change', function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_columns_to_filter", 'application/json', details, function (branches) {
    ...
    $("#apply").click(function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/process_null_columns", 'application/json', details, function (data) {
    ...
    $("#apply_conv").click(function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/process_attribute_encoding", 'application/json', details, function (data) {
    ...
    $("#hist_cols").on('change', function () {
        ...
        console.log(details)
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_graph_data", 'application/json', details, function (branches) {
