$(document).ready(function () {
    ...
    window.onload = function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_algorithm_params", 'application/json', null, function (branches) {
    ...
    $("#update").click(function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_algorithm_params", 'application/json', null, function (branches) {
            ...
            if (got_error == false) {
                ...
                ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/apply_selected_algorithms", 'application/json', resp_obj, function (branches) {
