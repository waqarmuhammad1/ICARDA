$(document).ready(function () {
    ...
    $('#upload-file-btn').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/uploader",
            data: form_data,
            contentType: false,
            cache: false,
            processData: false,
    ...
    function populate_data() {
        if (selected_source == 'excel') {
            ...
            ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_sheets", true, 'application/json', null, function (response) {
            ...
            ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_columns", true, 'application/json', request, function (response) {
            ...
            ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_data", true, 'application/json', request, function (response_data) {
    ...
    $("#set_selected").click(function () {
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/set_selected_data", true, 'application/json', null, function (response_data) {
    ...
    $("#connect-btn").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/read_database",
            data: request,
    ...
    $("#db_select").change(function(){
        ...
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/get_database_tables",
            data: request,
            contentType: 'application/json',
            cache: false,
            processData: false,
    ...
    $("#table_select").change(function(){
        ...
        ajaxCallsFunc('POST', configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/read_table", true, 'application/json', request, function (response_data) {
    ...
    $("#train_select").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/update_train_vars",
            data: request,
            contentType: 'application/json',
            cache: false,
            processData: false,
    ...
    $("#target_select").click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: configVariables.APPLICATION_DOMAIN + ":" + configVariables.API_PORT + "/update_target_vars",
            data: request,
            contentType: 'application/json',
            cache: false,
            processData: false,
